...
\cvsite{\url{http://github.com/nat13ejo}}%personal site


\aboutme{
  Mathematical Physicist with a passion for Software Engineering. I
  hope to find a position combining software engineering with
  mathematics.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\skills{
  {Respect of non-deserving authority/1},
  {Respect of deserving authority/5},
  {quantum mechanics/5},
  {git/4},
  {SVN/3},
  {c++/4},
